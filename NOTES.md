...
* Devices
    ...
    * Networking
        ...
        * Tunnel/VPN support
        * If MAC type is AUTO, still specify it on command line, using MAC generated by cirrinad, rather than letting bhyve generate it, because bhyve still uses the NetApp OUI and I want to be able to recognize my VMs from others.
        * Use 11:11:11 prefix, see [oui.txt](https://standards-oui.ieee.org/oui/oui.txt) for "Private" entries
