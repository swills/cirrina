...
var file_cirrina_proto_rawDesc = []byte{
	...
	0x74, 0x32, 0xc3, 0x02, 0x0a, 0x06, 0x56, 0x4d, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x23, 0x0a, 0x05,
	...
	0x69, 0x6e, 0x61, 0x2e, 0x56, 0x4d, 0x12, 0x2c, 0x0a, 0x06, 0x47, 0x65, 0x74, 0x56, 0x4d, 0x73,
	0x12, 0x11, 0x2e, 0x63, 0x69, 0x72, 0x72, 0x69, 0x6e, 0x61, 0x2e, 0x56, 0x4d, 0x73, 0x51, 0x75,
	0x65, 0x72, 0x79, 0x1a, 0x0d, 0x2e, 0x63, 0x69, 0x72, 0x72, 0x69, 0x6e, 0x61, 0x2e, 0x56, 0x6d,
	0x49, 0x44, 0x30, 0x01, 0x12, 0x2c, 0x0a, 0x07, 0x53, 0x74, 0x61, 0x72, 0x74, 0x56, 0x4d, 0x12,
	0x0d, 0x2e, 0x63, 0x69, 0x72, 0x72, 0x69, 0x6e, 0x61, 0x2e, 0x56, 0x6d, 0x49, 0x44, 0x1a, 0x12,
	...
	0x69, 0x72, 0x72, 0x69, 0x6e, 0x61, 0x2e, 0x56, 0x6d, 0x49, 0x44, 0x1a, 0x12, 0x2e, 0x63, 0x69,
	...
	0x65, 0x71, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x2d, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x56,
	0x4d, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x0d, 0x2e, 0x63, 0x69, 0x72, 0x72, 0x69, 0x6e, 0x61,
	0x2e, 0x56, 0x6d, 0x49, 0x44, 0x1a, 0x10, 0x2e, 0x63, 0x69, 0x72, 0x72, 0x69, 0x6e, 0x61, 0x2e,
	0x56, 0x4d, 0x53, 0x74, 0x61, 0x74, 0x65, 0x42, 0x20, 0x5a, 0x1e, 0x67, 0x69, 0x74, 0x6c, 0x61,
...
var file_cirrina_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
var file_cirrina_proto_depIdxs = []int32{
	...
	0, // 3: cirrina.VMInfo.StartVM:input_type -> cirrina.VmID
	0, // 4: cirrina.VMInfo.StopVM:input_type -> cirrina.VmID
	3, // 5: cirrina.VMInfo.RequestStatus:input_type -> cirrina.RequestID
	0, // 6: cirrina.VMInfo.GetVMState:input_type -> cirrina.VmID
	0, // 7: cirrina.VMInfo.AddVM:output_type -> cirrina.VmID
	1, // 8: cirrina.VMInfo.GetVM:output_type -> cirrina.VM
	0, // 9: cirrina.VMInfo.GetVMs:output_type -> cirrina.VmID
	3, // 10: cirrina.VMInfo.StartVM:output_type -> cirrina.RequestID
	3, // 11: cirrina.VMInfo.StopVM:output_type -> cirrina.RequestID
	4, // 12: cirrina.VMInfo.RequestStatus:output_type -> cirrina.ReqStatus
	5, // 13: cirrina.VMInfo.GetVMState:output_type -> cirrina.VMState
